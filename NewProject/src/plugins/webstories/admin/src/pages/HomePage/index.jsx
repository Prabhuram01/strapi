...
const HomePage = () => {
  ...
  const redirectToWebStories = async (e, typeOfWebsite) => {
    ...
    // const domainorip = "prod-webstories-cms.s3-website.ap-south-1.amazonaws.com/webstories";
            ...
            {loggedUserData ? (
              <>
                <div style={{ marginBottom: "2rem", marginTop: "2rem", display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: "1rem" }}>
                  ...
                  <Button variant="secondary" onClick={(e) => redirectToWebStories(e, "andhraJyothy")}>Andhra Jyothi Web Stories</Button>
                </div>
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: "1rem" }}>
                  ...
                  <Button variant="secondary" onClick={(e) => redirectToWebStories(e, "chitraJyothy")}>Chitra Jyothi Web Stories</Button>
                </div>
              </>
            ) : (
